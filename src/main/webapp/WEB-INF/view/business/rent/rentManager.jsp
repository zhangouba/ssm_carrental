...
<body class="childrenBody">
	...
	<form class="layui-form" method="post" id="searchFrm">
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<select name="rentflag" id="" lay-filter="mySelect">
	...
	<script id="RentBar" type="text/html">
		{{#  if(d.rentflag ==1){ }}
		<a class="layui-btn layui-btn-xs" lay-event="doExport">导出出租单</a>
		{{#  } else { }}
        ...
        layui.use([ 'jquery', 'layer', 'form', 'table',  'laydate'], function() {
            ...
            tableIns=table.render({
                ...
                ,cols: [[   //列表数据
                    ...
                    , {field: 'rentid', title: '订单编号', align: 'center', width: '300'}
                    , {field: 'identity', title: '身份证号', align: 'center', width: '120'}
                    ...
                    , {field: 'price', title: '出租价格', align: 'center', width: '150'}
