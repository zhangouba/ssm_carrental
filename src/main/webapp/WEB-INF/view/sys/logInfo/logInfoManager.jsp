...
<body class="childrenBody">
	...
	<form class="layui-form" method="post" id="searchFrm">
		<div class="layui-form-item">
            ...
            &nbsp;&nbsp;&nbsp;
			<div class="layui-inline">
				<label class="layui-form-label">登  录IP:</label>
				<div class="layui-input-inline">
	...
	<!-- 日志分配菜单的弹出层开始 -->
	<div style="display: none;" id="selectLogInfoMenu">
        ...
        layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[   //列表数据
                    ...
                    , {field: 'loginip', title: '日志ip', align: 'center'}
                    , {field: 'logintime', title: '时间', align: 'center'}
		   ...
		   table.on('tool(logInfoTable)', function(obj){
			...
			function deleteBatch(){
			    ...
			    layer.confirm('真的删除选中的这些日志吗', function(index){
				       //向服务端发送删除指令
				       $.post("${ctx}/logInfo/deleteBatchLogInfo.action",
						   params,
						   function(res){
				    	   layer.msg(res.msg);
				    	    //刷新数据 表格
