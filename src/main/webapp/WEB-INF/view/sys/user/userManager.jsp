	...
	<form class="layui-form" method="post" id="searchFrm">
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="radio" name="available" value="1" title="男">
		...
		<form class="layui-form"  lay-filter="dataFrm" id="dataFrm">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label">登录名称:</label>
					<div class="layui-input-inline">
						<input type="text" name="loginname" placeholder="请输入登录名称" autocomplete="off"
							   class="layui-input">
					</div>
				</div>
			</div>
			    ...
			    ,cols: [[   //列表数据
			     {type: 'checkbox', fixed: 'left'}
			      ...
			      ,{field:'loginname', title:'登录名',align:'center',width:'100'}
                   ,{field:'identity', title:'身份证',align:'center',width:'150'}
				  ...
				  layer.confirm('真的删除【'+data.realname +'】这个用户吗', function(index){
				    ...
				    $.post("${ctx}/user/deleteUser.action",{userid:data.userid},function(res){
				     ...
				     openselectUserRole(data);
                      ...
                      layer.confirm('真的要重置【'+data.realname +'】这个用户的密码吗', function(index){
                          //向服务端发送删除指令
                          $.post("${ctx}/user/resrtUserPwd.action",{userid:data.userid},function(res){
                              layer.msg(res.msg);
                              //刷新数据 表格
                              tableIns.reload();
                          })
