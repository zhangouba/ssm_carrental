...
public class ExprotRentUtils {
	...
	public static ByteArrayOutputStream exportRent(Rent rent, Customer customer, String sheetName) {
		...
		//画图片
        File file=new File("C:\\Users\\zhangouba\\Desktop\\图片\\wanjuche.jpg");
        InputStream logoStream = null;
        try {
            logoStream = new FileInputStream(file);
...
//        HSSFClientAnchor anchor2 = new HSSFClientAnchor(0, 0, 0, 255,(short) 4, 1, (short) 5, 1);
//        anchor2.setAnchorType(ClientAnchor.AnchorType.DONT_MOVE_AND_RESIZE);
//        patriarch.createPicture(anchor2, workbook.addPicture(bos.toByteArray(), HSSFWorkbook.PICTURE_TYPE_JPEG));
